...
// Define the navigation prop type for the component
type AddTransactionNavigationProp = StackNavigationProp<RootStackParamList, 'HomePage'>;

// Use the type for the 'navigation' prop
const AddTransaction = ({ navigation }: { navigation: AddTransactionNavigationProp }) => {
  return (
