...
const HomePage = ({ navigation, route }: Props) => {
  ...
  const [user, setUser] = useState<User>({ fullName: '', photo: '' });
      ...
      <View style={styles.pageContainer}>
        ...
        <View>
          ...
          <View style={styles.makanan}>
            ...
            <Text style={styles.text1}>cylindrical pasta. It is a staple food</Text>
            <Text style={styles.text2}>of traditional Italian cuisine. Like</Text>
            ...
            <Text style={styles.text5}>enriched with vitamins and minerals.</Text>
